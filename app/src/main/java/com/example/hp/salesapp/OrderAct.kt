...
class OrderAct : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var url="http://192.168.43.101/SalesWeb/get_temp.php?mobile="+UserInfo.mobile
    ...
    override fun onOptionsItemSelected(item: MenuItem?): Boolean {
        ...
        {
            var url="http://192.168.43.101/SalesWeb/cancel_order.php?mobile="+UserInfo.mobile
            var rq:RequestQueue=Volley.newRequestQueue(this)
        ...
        {
            var url="http://192.168.43.101/SalesWeb/confirm_order.php?mobile="+UserInfo.mobile
            var rq:RequestQueue=Volley.newRequestQueue(this)
            var sr= StringRequest(Request.Method.GET,url, Response.Listener { response ->
